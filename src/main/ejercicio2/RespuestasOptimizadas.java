...
public class RespuestasOptimizadas {
    // El estudiante debe escribir aquí las versiones
    //optimizadas y las
    // complejidades

    // 1. Versión optimizada de tieneDuplicados
    //(Complejidad anotada en la variable)
    ...
    // 2. Versión optimizada de contarMayores 
    //(Complejidad anotada en la variable)
    ...
    // 3. Versión optimizada de encontrarMaximo 
    //(Complejidad anotada en la variable)
